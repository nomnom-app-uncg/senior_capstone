...
const styles = StyleSheet.create({
    ...
    profileHeaderContainer: { alignItems: "center", marginBottom: 20 },
    backgroundImage: { width: "100%", height: 100, borderTopLeftRadius: 20, borderTopRightRadius: 20 },
    profileBox: {
        backgroundColor: "#fff",
        width: "100%",
        borderRadius: 10,
    ...
    profilePic: { width: 80, height: 80, borderRadius: 40, borderColor: "#ccc", borderWidth: 2 },
    textRow: { flexDirection: "row", marginTop: 10 },
    welcomeText: { fontWeight: "bold", fontSize: 18, marginRight: 4, textDecorationLine: "underline" },
    backText: { fontWeight: "bold", fontSize: 18, textDecorationLine: "underline" },
    profileName: { fontSize: 20, fontWeight: "bold", marginTop: 5, color: "#333" }, // ✅ Added
    bookmarkButton: { position: "absolute", top: 10, right: 10 },
    profileActionsRow: { flexDirection: "row", justifyContent: "space-between", width: "100%", paddingHorizontal: 10, marginTop: 12 },
    changePwButton: { backgroundColor: "#d1d1d1", paddingVertical: 8, paddingHorizontal: 25, borderRadius: 8 },
    deleteButtonAlt: { backgroundColor: "#d1d1d1", paddingVertical: 8, paddingHorizontal: 25, borderRadius: 8 },
    changePwButtonText: { fontWeight: "bold", color: "#444" },
    deleteButtonText: { fontWeight: "bold", color: "#444" },
    profileInfoBox: { marginTop: 16, width: "100%", paddingHorizontal: 20 },
    profileLabel: { fontWeight: "bold", fontSize: 16 },
    profileEmail: { fontSize: 15, marginBottom: 6, color: "#333" },
    logoutButton: { backgroundColor: "#4CAF50", marginTop: 16, paddingVertical: 10, paddingHorizontal: 40, borderRadius: 8 },
    logoutButtonText: { color: "#fff", fontWeight: "bold", fontSize: 16 },
    favoritesSection: { flex: 1 },
    sectionHeading: { fontSize: 28, fontWeight: "bold", textAlign: "center", marginBottom: 15 },
    noFavorites: { fontSize: 16, textAlign: "center", marginTop: 20, color: "#555" },
    listContainer: { paddingBottom: 20 },
    recipeCard: { backgroundColor: "#f9f9f9", padding: 15, borderRadius: 10, marginBottom: 15, borderWidth: 1, borderColor: "#ddd" },
    ...
    modalContent: { backgroundColor: "#fff", width: "100%", maxHeight: "80%", borderRadius: 10, padding: 20 },
    modalHeader: { flexDirection: "row", justifyContent: "space-between", marginBottom: 20 },
    closeButton: { backgroundColor: "#ff4d4f", borderRadius: 20, paddingHorizontal: 10, paddingVertical: 5 },
    closeButtonText: { color: "#fff", fontWeight: "bold", fontSize: 16 },
    removeModalButton: { backgroundColor: "#28a745", borderRadius: 20, paddingHorizontal: 10, paddingVertical: 5 },
